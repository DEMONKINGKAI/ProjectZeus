...
__all__ = [
    ...
    'DISPID_SRCCreateResultFromMemory', 'SRERequestUI',
    'SAFT8kHz8BitStereo', 'DISPID_SRCRecognizer', 'ISpGrammarBuilder',
    ...
    'SPEI_RESERVED5', 'SPDKL_CurrentConfig', 'SPLOADOPTIONS',
    'SPEI_SENTENCE_BOUNDARY', 'SAFT16kHz16BitStereo',
    'SpeechCategoryRecognizers', 'DISPID_SGRsCommitAndSave',
    'DISPID_SRRPhraseInfo', 'ISpRecognizer', 'SWTAdded', 'SBOPause',
    'SAFT11kHz16BitStereo', 'DISPID_SGRSTransitions',
    'DISPID_SpeechRecoResult2', 'SSSPTRelativeToStart', 'SVF_None',
    'DISPID_SPEDisplayAttributes', 'SPSInterjection', 'DISPID_SPPId',
    'DISPID_SpeechFileStream', 'DISPID_SOTDisplayUI',
    'SDA_Consume_Leading_Spaces', 'DISPID_SpeechPhraseReplacement',
    'SP_VISEME_14', 'SVSFParseSapi', 'ISpeechPhraseReplacements',
    'SAFT8kHz16BitMono', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SGRs_NewEnum', 'DISPID_SPPBRestorePhraseFromMemory',
    'SDKLCurrentConfig', 'SLTUser', 'ISpeechLexicon',
    'SVSFNLPSpeakPunc', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SVSCurrentStreamNumber', 'SPEI_RESERVED2',
    'SPPARTOFSPEECH', 'SVP_13', 'DISPID_SPPConfidence',
    'DISPID_SPIStartTime', 'ISpRecognizer2', 'SpMMAudioEnum',
    'SAFTGSM610_8kHzMono', 'eLEXTYPE_PRIVATE6', 'SWTDeleted',
    'SPEI_SOUND_START', 'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SVPriority', 'DISPID_SVEAudioLevel', 'DISPID_SVEViseme',
    'DISPID_SRGetFormat', 'DISPID_SGRSAddSpecialTransition',
    'eWORDTYPE_ADDED', 'ISpeechAudioStatus',
    'SpeechTokenIdUserLexicon', 'SPSHT_EMAIL', 'DISPID_SRState',
    'DISPID_SRSAudioStatus', 'SLODynamic', 'ISpeechXMLRecoResult',
    'SFTInput', 'SASStop', 'DISPID_SPRsCount',
    'DISPID_SAFGetWaveFormatEx', 'LONG_PTR', 'DISPID_SBSFormat',
    'DISPID_SVGetAudioOutputs', 'SpeechAudioProperties',
    'SpStreamFormatConverter', 'DISPID_SRCESoundEnd',
    'DISPID_SPEsItem', 'SAFT16kHz8BitMono', 'eLEXTYPE_RESERVED8',
    'SpObjectToken', 'SPAR_High', 'DISPID_SRCEventInterests',
    'DISPID_SRGDictationLoad', 'DISPID_SGRAttributes',
    'Speech_StreamPos_RealTime', 'SpeechGrammarTagUnlimitedDictation',
    'SAFTADPCM_22kHzMono', 'SRERecoOtherContext', 'SITooQuiet',
    'SPGRAMMARWORDTYPE', 'SpeechTokenContext', 'SpeechStreamFileMode',
    'DISPID_SRGRules', 'SPSHORTCUTTYPE', 'SAFTCCITT_uLaw_8kHzMono',
    'SPSHORTCUTPAIR', 'ISpeechPhraseAlternates', 'ISpProperties',
    'SPEI_SR_PRIVATE', 'ISpeechPhraseElements', 'SPFM_OPEN_READWRITE',
    'DISPID_SVPause', 'SRAImport', 'DISPID_SVAudioOutputStream',
    'DISPID_SVAudioOutput', 'SpeechPropertyResourceUsage',
    'STSF_AppData', 'DISPID_SGRsFindRule',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SGRSRule',
    ...
    'SREStateChange', 'SPEI_START_SR_STREAM',
    'DISPID_SOTCreateInstance', 'SINone', 'ISpStreamFormatConverter',
    'SVEEndInputStream', 'SGPronounciation', 'SpNotifyTranslator',
    'DISPID_SPPParent', 'SPRECOSTATE', 'DISPID_SPCIdToPhone',
    'ISpRecoCategory', 'SP_VISEME_1', 'DISPID_SOTIsUISupported',
    'ISpObjectWithToken', 'DISPID_SPPValue',
    'DISPID_SVSInputWordPosition', 'DISPID_SRSetPropertyNumber',
    'ISpeechGrammarRuleState', 'SAFT11kHz16BitMono', 'SRTStandard',
    'SPWORDPRONUNCIATION', 'SPEI_TTS_BOOKMARK', 'SASPause',
    'SPPHRASE', 'SP_VISEME_21', 'SAFT44kHz16BitMono',
    'SpMemoryStream', 'SVP_20', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SPCLangId', 'SRTExtendableParse',
    'SDA_Two_Trailing_Spaces', 'SDTAudio', 'DISPID_SLPType',
    'DISPID_SVDisplayUI', 'DISPID_SDKEnumValues',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SRGId',
    'SAFT32kHz8BitMono', 'SVEViseme', 'DISPID_SLGetPronunciations',
    'DISPID_SLWsCount', 'DISPID_SPIEnginePrivateData', 'SpStream',
    'SPPS_Unknown', 'SGRSTTRule', 'SPWAVEFORMATTYPE',
    ...
    'DISPID_SVEBookmark', 'SAFT22kHz16BitMono', 'tagSPPROPERTYINFO',
    'SP_VISEME_16', 'SPEI_START_INPUT_STREAM', 'SRSActiveAlways',
    'SRERecognition', 'eLEXTYPE_APP', 'ISpEventSink',
    'SpeechVoiceSkipTypeSentence', 'SAFT32kHz16BitStereo',
    'DISPID_SpeechRecoContext', 'SDKLCurrentUser',
    'DISPID_SWFESamplesPerSec', 'SPXRO_SML', 'eLEXTYPE_PRIVATE3',
    'SRSInactive', 'DISPID_SRCEHypothesis', 'SVP_17',
    'SpPhoneConverter', 'ISpRecoContext', 'SINoSignal',
    'DISPID_SAVolume', 'SVP_12', 'DISPID_SRCEPropertyNumberChange',
    'SPXRO_Alternates_SML', 'SpeechCategoryAudioIn',
    'SpeechRegistryUserRoot', 'SAFT24kHz8BitMono',
    'SAFT24kHz16BitStereo', 'SRESoundEnd', '__MIDL_IWinTypes_0009',
    'SPEI_ADAPTATION', 'SPADAPTATIONRELEVANCE',
    'DISPID_SWFEBlockAlign', 'eLEXTYPE_PRIVATE5', 'SPAR_Medium',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SFSClose',
    ...
    'SVSFlagsAsync', 'SPEI_MAX_TTS', 'SpeechAudioVolume',
    'SP_VISEME_10', 'Speech_Max_Pron_Length', 'SPPS_Interjection',
    'SPPS_SuppressWord', 'DISPID_SRRTimes',
    'DISPID_SpeechObjectTokens', 'DISPID_SDKDeleteValue',
    'DISPID_SFSOpen', 'eLEXTYPE_PRIVATE7', 'SPFM_CREATE_ALWAYS',
    'DISPID_SPPName', 'SPEI_REQUEST_UI', 'SpSharedRecognizer',
    'SAFT48kHz8BitStereo', 'DISPID_SRCEAudioLevel',
    'DISPID_SPANumberOfElementsInResult', 'ISpeechPhraseAlternate',
    'SPPHRASERULE', 'SAFTGSM610_11kHzMono', 'DISPID_SpeechPhraseInfo',
    ...
    'SPEI_WORD_BOUNDARY', 'DISPID_SLGenerationId', 'SPPHRASEELEMENT',
    'DISPID_SVSPhonemeId', 'SECFNoSpecialChars',
    'IEnumSpObjectTokens', 'SPWF_INPUT',
    'DISPID_SRSCurrentStreamNumber', 'SPSEMANTICFORMAT',
    'SP_VISEME_13', 'SPEI_END_INPUT_STREAM', 'SRTReSent',
    'DISPID_SPRsItem', 'ISpeechVoice', 'ISpeechRecoGrammar',
    'SPCT_COMMAND', 'SPEVENTSOURCEINFO', 'DISPID_SPPsCount',
    'SP_VISEME_7', 'ISpeechObjectTokenCategory', 'DISPID_SOTCSetId',
    ...
    'SpeechDictationTopicSpelling', 'SRADefaultToActive',
    'IInternetSecurityMgrSite', 'DISPID_SRSSupportedLanguages',
    'SVP_5', 'eLEXTYPE_MORPHOLOGY', 'DISPIDSPTSI',
    'DISPID_SpeechAudioStatus', 'SpeechCategoryPhoneConverters',
    'DISPID_SVSpeak', 'DISPID_SOTRemoveStorageFileName',
    'SPEI_MAX_SR', 'DISPID_SPRFirstElement',
    'DISPID_SpeechObjectToken', 'SPSNotOverriden', 'SpeechAudioState',
    'SAFT22kHz8BitStereo', 'SPEI_MIN_SR', 'eLEXTYPE_PRIVATE2',
    'SpeechCategoryVoices', 'DISPID_SOTRemove', 'SRTSMLTimeout',
    ...
    'DISPID_SPEAudioTimeOffset', 'SVPNormal', 'eLEXTYPE_PRIVATE16',
    'DISPID_SpeechAudioBufferInfo', 'SSSPTRelativeToCurrentPosition',
    'ISpLexicon', 'DISPID_SpeechPhraseAlternates', 'SPSHT_Unknown',
    'SPEI_VOICE_CHANGE', 'SDTAll', 'SECFDefault', 'SDTReplacement',
    'DISPID_SpeechMemoryStream', 'Speech_StreamPos_Asap',
    'DISPID_SGRId', 'SRTAutopause', 'SPAR_Low', 'SPEVENT',
    'DISPID_SPRuleName', 'DISPID_SpeechBaseStream',
    'DISPID_SRRAudioFormat', 'DISPID_SVSkip', 'DISPID_SGRSTNextState',
    'SECFIgnoreKanaType', 'DISPID_SPPsItem', 'SGRSTTWord',
    'DISPID_SAFType', 'DISPID_SPIAudioSizeTime',
    'SpeechEmulationCompareFlags', 'eLEXTYPE_PRIVATE8',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SVEStreamStart',
    'DISPID_SOTSetId', 'SPEI_VISEME', 'DISPID_SRRSpeakAudio',
    'UINT_PTR', 'SpeechEngineConfidence', 'IEnumString',
    'SVF_Emphasis', 'SpWaveFormatEx', 'SAFTGSM610_44kHzMono',
    'SpeechDataKeyLocation', 'ISpRecognizer3', 'SVP_4',
    'SPGS_DISABLED', 'DISPID_SRCERecognizerStateChange', 'SPAS_STOP',
    'SPCATEGORYTYPE', 'SpeechCategoryAudioOut', 'SVSFIsNotXML',
    'SPVPRI_ALERT', 'SpeechDisplayAttributes', 'SSTTWildcard',
    'ISpObjectToken', 'SAFT12kHz16BitMono', 'DISPID_SLPsItem',
    '_RemotableHandle', 'SPPHRASEPROPERTY', 'SPAUDIOBUFFERINFO',
    'DISPID_SRIsUISupported', 'DISPID_SpeechRecognizerStatus',
    'SPPS_LMA', 'SAFT16kHz16BitMono', 'DISPID_SPRulesCount',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SRCEEndStream',
    'DISPID_SpeechPhoneConverter', 'SPAO_RETAIN_AUDIO',
    'DISPID_SRProfile', 'DISPID_SVResume', 'SPFM_CREATE',
    'SPGRAMMARSTATE', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SGRInitialState',
    'DISPID_SRCResume', 'DISPID_SRRTStreamTime', 'STCRemoteServer',
    'SPVPRI_NORMAL', 'DISPID_SMSADeviceId', 'SPXMLRESULTOPTIONS',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SPERetainedStreamOffset', 'SpeechVisemeType', 'SVP_10',
    'SVSFIsXML', 'SPINTERFERENCE_NONE', 'SPPS_RESERVED4',
    'SVEStartInputStream', 'SAFT12kHz8BitStereo',
    'SPRST_INACTIVE_WITH_PURGE', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SRSNumberOfActiveRules', 'ISpEventSource',
    'SPRST_ACTIVE_ALWAYS', 'SAFTADPCM_22kHzStereo', 'SPLO_DYNAMIC',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SPBINARYGRAMMAR',
    'DISPID_SLPs_NewEnum', 'SAFTADPCM_44kHzMono',
    'DISPID_SVESentenceBoundary', 'DISPID_SRGRecoContext',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SRSetPropertyString',
    'DISPID_SVSLastStreamNumberQueued', 'SpeechTokenValueCLSID',
    'SVP_19', 'STSF_FlagCreate', 'DISPID_SGRSTWeight',
    'SAFT22kHz8BitMono', 'SpeechMicTraining', 'DISPID_SDKDeleteKey',
    'SREStreamStart', 'eLEXTYPE_PRIVATE11',
    'SpeechVoiceCategoryTTSRate', 'SPPS_NotOverriden',
    'SpNullPhoneConverter', 'SGRSTTEpsilon',
    'SWPUnknownWordPronounceable', 'SVP_11', 'SGLexical',
    'SpTextSelectionInformation', 'SVP_9', 'SDKLLocalMachine',
    'SDTPronunciation', 'SAFT48kHz16BitMono',
    'SWPKnownWordPronounceable', 'SAFT44kHz16BitStereo',
    'eLEXTYPE_RESERVED7', 'SAFTCCITT_uLaw_8kHzStereo',
    ...
    'DISPIDSPTSI_ActiveOffset', 'SPRECORESULTTIMES', 'SpMMAudioOut',
    'DISPID_SPPChildren', 'DISPID_SPPFirstElement',
    'DISPID_SpeechLexiconPronunciation', 'SpeechRuleState', 'SVP_1',
    'SDTRule', 'DISPID_SVEEnginePrivate', 'DISPID_SPAs_NewEnum',
    'SPEI_UNDEFINED', 'SGSEnabled', 'Speech_Max_Word_Length',
    'SGDisplay', 'DISPID_SpeechRecognizer', 'DISPID_SVGetAudioInputs',
    'DISPID_SVSpeakStream', 'eLEXTYPE_LETTERTOSOUND',
    'SAFT12kHz8BitMono', '_ISpeechVoiceEvents', 'SSFMCreate',
    'DISPID_SRCERequestUI', 'SAFTADPCM_44kHzStereo',
    'SpeechGrammarWordType', 'DISPID_SLPPhoneIds', 'SPEI_RESERVED3',
    'SPWORDTYPE', 'SpShortcut', 'DISPID_SGRSTPropertyValue',
    'DISPID_SGRSTsCount', 'DISPID_SPEs_NewEnum', 'SITooLoud',
    'DISPID_SRCreateRecoContext', 'ISpShortcut', 'SAFT44kHz8BitMono',
    'DISPID_SOTGetDescription', 'DISPID_SGRSTsItem', 'SITooFast',
    'SP_VISEME_20', 'SpCompressedLexicon', 'SP_VISEME_8',
    'DISPID_SPRNumberOfElements', 'DISPID_SVStatus',
    'Speech_Default_Weight', 'SpeechLoadOption',
    'DISPID_SPRuleNumberOfElements', 'SPAS_PAUSE',
    'ISpeechAudioFormat', 'SRSEDone', 'SGDSInactive',
    'SpeechCategoryAppLexicons', 'SVPOver',
    'SAFTCCITT_ALaw_11kHzMono', 'SVSFPersistXML', 'SGDSActive',
    'DISPID_SLWPronunciations', 'DISPID_SpeechVoiceEvent',
    'SPRS_ACTIVE', 'SP_VISEME_19', 'SSFMOpenForRead',
    'SAFTNoAssignedFormat', 'ISpPhraseAlt', 'SPEI_RECO_OTHER_CONTEXT',
    'SVEAudioLevel', 'eLEXTYPE_RESERVED10',
    'SpeechGrammarTagDictation', 'DISPID_SRGIsPronounceable',
    'SPWT_DISPLAY', 'ISpRecoGrammar2', 'DISPID_SLWType',
    'DISPID_SGRsDynamic', 'DISPID_SLGetWords', 'DISPID_SDKCreateKey',
    'SP_VISEME_0', 'SRTEmulated', 'SDTDisplayText', 'SpCustomStream',
    ...
    'SPPS_Noncontent', 'SREInterference', 'DISPID_SABIBufferSize',
    'eLEXTYPE_PRIVATE18', 'SpeechAudioFormatGUIDText', 'SPBO_PAUSE',
    'DISPID_SOTsItem', 'SVESentenceBoundary', 'SPVPRIORITY',
    'ISpeechCustomStream', 'SAFTGSM610_22kHzMono',
    'ISpeechLexiconWords', 'SLTApp', 'SRCS_Disabled',
    'DISPID_SVSLastResult', 'SpeechVoiceEvents', 'DISPID_SpeechAudio',
    'SPLEXICONTYPE', 'DISPID_SPIReplacements', 'SPBO_NONE',
    'DISPID_SWFEChannels', 'DISPID_SOTMatchesAttributes',
    'DISPID_SPIGetText', 'SVP_2', 'SPPHRASEREPLACEMENT',
    'SP_VISEME_5', 'DISPID_SPPEngineConfidence',
    'DISPID_SpeechPhraseProperty', 'DISPID_SRGState',
    'SPDATAKEYLOCATION', 'DISPID_SVEStreamEnd',
    'SpeechRecoProfileProperties', 'SAFT32kHz16BitMono',
    'ISpResourceManager', 'DISPID_SRGCmdLoadFromResource',
    'SLOStatic', 'SPLO_STATIC', 'SGRSTTDictation',
    'SpeechVisemeFeature', 'ISpPhoneticAlphabetSelection',
    'eWORDTYPE_DELETED', 'SECFIgnoreCase', 'SpeechWordPronounceable',
    'DISPID_SPPNumberOfElements', 'SVSFParseAutodetect',
    'DISPID_SWFEBitsPerSample', 'SRAExport',
    'SpeechTokenKeyAttributes', 'DISPID_SLAddPronunciation',
    'eLEXTYPE_PRIVATE10', 'SAFTDefault', 'DISPID_SGRClear',
    'DISPID_SRCEPropertyStringChange', 'ISpeechPhraseReplacement',
    'SpeechAudioFormatType', 'SGRSTTTextBuffer',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SDA_One_Trailing_Space',
    'DISPID_SPRuleFirstElement', 'DISPID_SRGetRecognizers',
    '_SPAUDIOSTATE', 'SDTProperty', 'DISPID_SPCPhoneToId',
    'DISPID_SRCRetainedAudio', 'DISPID_SRCERecognition',
    'DISPID_SWFEExtraData', 'SRAONone', 'DISPID_SADefaultFormat',
    'DISPID_SVEPhoneme', 'SPEI_TTS_PRIVATE', 'SpInprocRecognizer',
    'SAFTNonStandardFormat', 'SPWORDPRONUNCIATIONLIST', 'SASClosed',
    'SPSSuppressWord', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SpeechWordType', 'DISPID_SRCRequestedUIType',
    'ISpeechPhraseProperties', 'ISpeechLexiconWord', 'SPPS_Noun',
    'DISPID_SDKOpenKey', 'SSFMCreateForWrite', 'SVP_7',
    'ISpeechFileStream', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SGRsAdd', 'DISPID_SRGDictationSetState', 'SPPS_RESERVED2',
    'SPINTERFERENCE_TOOLOUD', 'SVEBookmark', 'SRSActive',
    'DISPID_SAEventHandle', 'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SRSClsidEngine', 'ISpeechPhraseRule',
    ...
    'eLEXTYPE_PRIVATE14', 'SAFTCCITT_uLaw_11kHzStereo',
    'SPVOICESTATUS', 'DISPID_SABufferNotifySize', 'DISPID_SGRSTType',
    'eLEXTYPE_PRIVATE15', 'DISPID_SRCEInterference',
    'DISPID_SRCESoundStart', 'SpeechPropertyComplexResponseSpeed',
    'SDTAlternates', 'SREPropertyStringChange', 'SPAUDIOOPTIONS',
    'DISPID_SpeechDataKey', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SPIProperties', 'DISPID_SGRSTPropertyId',
    'DISPID_SVSRunningState', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SOTId', 'DISPID_SLWWord', 'SAFTADPCM_8kHzStereo',
    'SAFTCCITT_ALaw_11kHzStereo', 'SPSVerb', 'SPBO_AHEAD',
    'SREHypothesis', 'DISPID_SRIsShared', 'SPPS_RESERVED3',
    'ISpeechAudio', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SPIGrammarId', 'SPEI_PHONEME', 'SpMMAudioIn', 'SPRULE',
    'DISPID_SGRsCount', 'ISpRecoContext2', 'SAFTText',
    'ISpeechGrammarRuleStateTransitions',
    'DISPID_SPAStartElementInResult', 'SPVISEMES', 'SVP_15',
    'SPSHT_OTHER', 'SAFTCCITT_ALaw_44kHzStereo', 'SPAS_RUN',
    'SAFT12kHz16BitStereo', 'ISpStream', 'DISPID_SOTGetAttribute',
    'SREBookmark', 'SPEI_FALSE_RECOGNITION', 'ISpeechBaseStream',
    'SAFTADPCM_8kHzMono', 'DISPID_SpeechVoiceStatus',
    'DISPID_SpeechMMSysAudio', 'SP_VISEME_11', 'DISPID_SPARecoResult',
    'DISPID_SpeechVoice', 'eLEXTYPE_PRIVATE12',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPDKL_LocalMachine',
    'SPCONTEXTSTATE', 'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SVSVisemeId', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SWFEFormatTag', 'STCAll', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SVRate', 'DISPID_SLPLangId', 'DISPID_SPILanguageId',
    'SREFalseRecognition', 'SpeechFormatType', 'DISPID_SRAudioInput',
    'SPEI_END_SR_STREAM', 'SPEI_SR_RETAINEDAUDIO', 'SPFM_NUM_MODES',
    'ISpNotifyTranslator', 'DISPID_SPRules_NewEnum', 'SPFILEMODE',
    'SpeechAddRemoveWord', 'SPPS_RESERVED1', 'SpVoice', 'ISpDataKey',
    'ISpeechVoiceStatus', 'DISPID_SGRName', 'SP_VISEME_3',
    'SSTTTextBuffer', 'SAFT32kHz8BitStereo', 'STCInprocHandler',
    'SPINTERFERENCE', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SpeechAudioFormat', 'DISPID_SRRAudio',
    'DISPID_SpeechRecoContextEvents', 'ISpStreamFormat',
    'SPVPRI_OVER', 'DISPID_SASFreeBufferSpace', 'SpPhraseInfoBuilder',
    'DISPID_SVSLastBookmark', 'DISPID_SVEventInterests',
    'ISpeechObjectToken', 'SINoise', 'DISPID_SpeechPhraseRule',
    'SP_VISEME_6', 'SPPS_Verb', 'ISpeechPhraseRules',
    'DISPID_SPRuleChildren', 'ISpSerializeState',
    'DISPID_SLPSymbolic', 'DISPID_SGRAddResource', 'SpeechRunState',
    'DISPID_SRCVoice', 'DISPID_SRRSaveToMemory', 'DISPID_SPAsCount',
    'SVEPrivate', 'SVP_21', 'SSFMOpenReadWrite',
    'DISPID_SLGetGenerationChange', 'SPAR_Unknown',
    'SPCT_SUB_COMMAND', 'ISpeechRecoResultTimes',
    'SpeechGrammarState', 'DISPID_SGRSTText', 'ISpeechGrammarRule',
    'DISPID_SOTGetStorageFileName', 'ISpeechPhraseInfoBuilder',
    'SAFT11kHz8BitMono', 'ISpeechRecoContext', 'SRATopLevel',
    'DISPID_SDKEnumKeys', 'DISPID_SRCPause',
    'DISPID_SPEPronunciation', 'SECLowConfidence',
    'SAFTCCITT_uLaw_44kHzMono', 'SPWORDLIST', 'SP_VISEME_9',
    'SpeechRegistryLocalMachineRoot', 'ISpeechRecoResult', 'ISpAudio',
    'ISpRecoResult', 'ISpeechTextSelectionInformation',
    'DISPID_SOTCategory', 'SPINTERFERENCE_NOSIGNAL',
    'SpeechAllElements', 'SREAdaptation', 'DISPID_SVEVoiceChange',
    'SpeechTokenShellFolder', 'SPRS_INACTIVE',
    'DISPID_SRGSetWordSequenceData', 'SPPS_Modifier',
    'eLEXTYPE_RESERVED6', 'SVP_18', 'SPAUDIOSTATUS',
    'eLEXTYPE_PRIVATE1', 'SpeechTokenKeyFiles', 'SP_VISEME_2',
    'SREStreamEnd', 'SpeechRetainedAudioOptions',
    'SAFTExtendedAudioFormat', 'SAFT11kHz8BitStereo',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SPELexicalForm', 'SVP_8',
    'SPCT_DICTATION', 'DISPID_SRCState', 'SPBO_TIME_UNITS',
    'SPSMF_SAPI_PROPERTIES', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SRCEAdaptation', 'DISPID_SRCEEnginePrivate',
    'DISPID_SOTCDefault', 'SPDKL_CurrentUser', 'SVSFPurgeBeforeSpeak',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SRGCmdLoadFromObject',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SPAPhraseInfo',
    'WAVEFORMATEX', 'SGSDisabled', 'tagSPTEXTSELECTIONINFO',
    'ISpeechRecognizer', 'SPWT_LEXICAL', 'SECFEmulateResult',
    'SpFileStream', 'SBONone', 'SPSNoun', 'DISPID_SGRAddState',
    'STSF_LocalAppData', 'DISPID_SOTs_NewEnum', 'SPSMF_UPS',
    'ISpNotifySink', 'ISpeechDataKey', 'DISPID_SBSSeek',
    'SGLexicalNoSpecialChars', 'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SpeechPhraseElement', 'SpeechEngineProperties',
    'SVEVoiceChange', 'SPGS_EXCLUSIVE', 'DISPID_SRCCreateGrammar',
    ...
    'DISPID_SRRTTickCount', 'SVEAllEvents',
    'DISPID_SpeechLexiconProns', 'DISPID_SRCBookmark', 'SPSLMA',
    'SECNormalConfidence', 'DISPID_SVAlertBoundary', 'SPCT_SLEEP',
    ...
    'SVSFVoiceMask', 'SREAudioLevel', 'DISPID_SRRTOffsetFromStart',
    'SVP_3', 'SPEI_RECO_STATE_CHANGE', 'SP_VISEME_15',
    'DISPID_SOTCGetDataKey', 'SVP_0', 'SVEPhoneme',
    'DISPID_SVWaitUntilDone', 'eLEXTYPE_RESERVED9',
    'SpeechVoiceSpeakFlags', 'SPDKL_DefaultLocation', 'SREAllEvents',
    'SPPROPERTYINFO', 'DISPIDSPTSI_SelectionLength',
    'SPEI_RECOGNITION', 'DISPID_SLAddPronunciationByPhoneIds',
    'SPEI_MIN_TTS', 'SpeechGrammarRuleStateTransitionType',
    'SPEI_RESERVED6', 'DISPID_SASState', 'SPEVENTENUM',
    'DISPID_SVEWord', 'DISPIDSPRG', 'SPEI_INTERFERENCE',
    'DISPID_SPRulesItem', 'SPSModifier', 'ISpeechResourceLoader',
    'SGSExclusive', 'SDTLexicalForm', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SpeechPhraseElements', 'eLEXTYPE_PRIVATE17',
    'DISPID_SABIEventBias', 'SP_VISEME_4',
    'DISPID_SRRSetTextFeedback', 'DISPID_SpeechPhraseBuilder',
    'SPEI_SR_BOOKMARK', 'SRARoot', 'DISPID_SDKSetStringValue',
    'SFTSREngine', 'SAFTADPCM_11kHzMono', 'DISPID_SPEsCount',
    'SP_VISEME_18', 'SRSInactiveWithPurge', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SPEAudioSizeTime', 'DISPID_SMSAMMHandle', 'SPWORD',
    'DISPID_SLWsItem', 'DISPID_SRGCommit', 'SGDSActiveUserDelimited',
    'SPWORDPRONOUNCEABLE', 'SpInProcRecoContext',
    'SpeechRecognitionType', 'DISPID_SMSSetData', 'ISequentialStream',
    'ISpeechWaveFormatEx', 'SpeechRuleAttributes',
    'SPSERIALIZEDRESULT', 'tagSTATSTG', 'SGRSTTWildcard',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SpeechPhraseReplacements',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SVGetVoices',
    'ISpeechPhraseInfo', 'SpeechBookmarkOptions',
    'DISPID_SpeechGrammarRuleStateTransition',
    'SpObjectTokenCategory', 'SECHighConfidence', 'SVF_Stressed',
    'SPRST_ACTIVE', 'DISPID_SBSWrite', 'SVSFUnusedFlags',
    ...
    'SpeechUserTraining', 'SPEI_SOUND_END', 'DISPID_SVIsUISupported',
    'SPINTERFERENCE_LATENCY_WARNING', 'SPGS_ENABLED',
    'SPWT_PRONUNCIATION', 'SpAudioFormat', 'DISPID_SpeechRecoResult',
    'SPSUnknown', 'eLEXTYPE_PRIVATE4', 'SPCT_SUB_DICTATION',
    'SpeechGrammarTagWildcard', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SpeechRecoEvents', 'SpeechStreamSeekPositionType',
    'SPFM_OPEN_READONLY', 'STSF_CommonAppData', 'SVP_16',
    'SPEI_TTS_AUDIO_LEVEL', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'ISpPhrase', 'SSSPTRelativeToEnd', 'ISpeechMemoryStream',
    'SpLexicon', 'SAFTCCITT_uLaw_44kHzStereo',
    'SpeechPropertyResponseSpeed', 'SRAInterpreter',
    'DISPID_SRCEStartStream', 'SPEI_HYPOTHESIS',
    'SAFTCCITT_ALaw_22kHzStereo', 'SVSFIsFilename',
    'eLEXTYPE_PRIVATE9', 'SAFT16kHz8BitStereo', 'DISPID_SASetState',
    'DISPID_SVSInputSentencePosition', 'SPWF_SRENGINE',
    'SPPS_Function', 'SAFT8kHz8BitMono', 'ISpeechObjectTokens',
    'ISpVoice', 'DISPID_SPRDisplayAttributes', 'ISpRecoGrammar',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SPRuleConfidence',
    'DISPID_SRRAlternates', 'DISPID_SpeechLexicon', 'IStream',
    'DISPID_SPEAudioStreamOffset', 'SPSFunction', 'SVP_14',
    'IInternetSecurityManager', 'SVSFParseMask', 'DISPID_SMSALineId',
    'eLEXTYPE_PRIVATE13', 'DISPID_SRRTLength',
    'DISPID_SRGDictationUnload', 'STCLocalServer',
    'SpSharedRecoContext', 'eLEXTYPE_RESERVED4', 'SVEWordBoundary',
    'SVP_6', 'DISPID_SRCRetainedAudioFormat', 'DISPID_SAFGuid',
    'SPSERIALIZEDPHRASE', 'ISpeechRecognizerStatus', 'SP_VISEME_12',
    'DISPID_SVVoice', 'DISPID_SpeechGrammarRule',
    'DISPID_SPPs_NewEnum', 'SRCS_Enabled', 'DISPID_SGRSTs_NewEnum',
    'SPRECOGNIZERSTATUS', 'SpResourceManager', 'DISPID_SCSBaseStream',
    'ISpeechGrammarRules', 'SPAUDIOSTATE', 'SpeechDiscardType',
    'eLEXTYPE_USER_SHORTCUT', 'SPRECOCONTEXTSTATUS',
    'SECFIgnoreWidth', 'DISPID_SRCEBookmark', 'SVSFDefault',
    'SDA_No_Trailing_Space', 'DISPID_SVVolume', 'DISPID_SPRText',
    'SpeechPartOfSpeech', 'DISPID_SRGSetTextSelection',
    'SRAORetainAudio', 'SAFT48kHz16BitStereo', 'eLEXTYPE_PRIVATE20',
    'STCInprocServer', 'DISPID_SASNonBlockingIO',
    'DISPID_SPIElements', 'SpeechCategoryRecoProfiles',
    'DISPID_SGRSTRule', 'DISPID_SpeechCustomStream',
    'DISPID_SRAudioInputStream', 'DISPID_SPEDisplayText', 'SASRun',
    'DISPID_SRStatus', 'DISPID_SpeechLexiconWords', 'SPCS_DISABLED',
    'ISpPhoneConverter', 'ISpeechPhraseElement',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SPISaveToMemory',
    'ISpNotifySource', 'SpeechSpecialTransitionType', 'SVSFNLPMask',
    'DISPID_SLPPartOfSpeech', 'DISPID_SGRsCommit', 'DISPID_SGRsItem',
    'DISPID_SPIEngineId', 'DISPID_SPIAudioSizeBytes',
    'SPINTERFERENCE_TOOFAST', 'SITooSlow',
    'ISpPhoneticAlphabetConverter', 'SPEI_RESERVED1',
    'ISpeechMMSysAudio', 'SVPAlert', 'ISpMMSysAudio',
    'DISPID_SPIRule', 'SGDSActiveWithAutoPause', 'SRADynamic',
    'SPAO_NONE', 'SREPhraseStart', 'SREPrivate', 'SAFT24kHz16BitMono',
    ...
    'DISPID_SLWs_NewEnum', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SPACommit', 'SREPropertyNumChange',
    ...
    'DISPID_SWFEAvgBytesPerSec', 'SPRULESTATE',
    'DISPID_SGRSAddRuleTransition', 'SAFT8kHz16BitStereo',
    'DISPID_SpeechLexiconWord', 'DISPID_SRCSetAdaptationData',
    'ISpeechRecoResult2', 'SVSFParseSsml', 'DISPID_SRDisplayUI',
    'DISPID_SVSLastBookmarkId', 'SPSHT_NotOverriden'
]

_check_version('1.2.0', 1689404335.296223)
